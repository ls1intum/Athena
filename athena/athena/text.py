...
from .schemas import TextExercise, GradedTextFeedback, TextSubmission, TextLanguageEnum
...
GradedFeedback = GradedTextFeedback
...
__all__ = [
    "Exercise", "Submission", "GradedFeedback", "TextLanguageEnum",
