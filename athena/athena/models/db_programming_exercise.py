...
class DBProgrammingExercise(DBExercise, Base):
    ...
    programming_language: str = Column(String)  # type: ignore
    solution_repository_url: str = Column(String) # type: ignore
    template_repository_url: str = Column(String) # type: ignore
    tests_repository_url: str = Column(String)  # type: ignore
