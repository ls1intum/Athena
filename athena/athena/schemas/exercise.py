...
from .structured_grading_instruction import StructuredGradingInstructionGroup
...
class Exercise(Schema, ABC):
    ...
    grading_criteria: Optional[List[StructuredGradingInstructionGroup]] = Field(None, description="The structured grading criteria for the exercise as a structured list.")
