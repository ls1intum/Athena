    ...
    <div className="m-2 border border-gray-300 rounded-lg text-sm max-w-3xl">
      ...
      <div className="flex justify-start items-center space-x-2 px-4 py-2">
        ...
        <div className="flex flex-col space-y-1 w-24">
          <button
            className={twMerge("bg-red-100 text-red-800 rounded px-2 py-0.5 hover:bg-red-200 hover:text-red-900",
              confirmDelete ? "bg-red-500 text-white hover:bg-red-600 hover:text-white" : "")
            }
            onClick={() => {
              if (confirmDelete) {
          ...
          <button
            className={twMerge(
              "rounded px-2 py-0.5",
              isEditing ? "bg-primary-100 text-primary-800 hover:bg-primary-200 hover:text-primary-900"
