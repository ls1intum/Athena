...
import RequestGradedFeedbackSuggestions
    from "@/components/view_mode/module_requests/request_graded_feedback_suggestions";
import RequestNonGradedFeedbackSuggestions
    from "@/components/view_mode/module_requests/request_non_graded_feedback_suggestions";
...
export default function ModuleRequests() {
    const [moduleAndConfig, setModuleAndConfig] = useState<{
        module: ModuleMeta;
        moduleConfig: any
    } | undefined>(undefined);
