...
async def generate_suggestions_by_file(exercise: Exercise, submission: Submission, config: NonGradedBasicApproachConfig,
                                       debug: bool) -> List[NonGradedFeedback]:
    ...
    solution_summary = await generate_summary_by_file(exercise=exercise, submission=submission,
