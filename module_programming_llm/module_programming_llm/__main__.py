...
async def suggest_feedback(exercise: Exercise, submission: Submission, is_graded: bool, module_config: Configuration) -> List[Feedback]:
    ...
    if is_graded:
        ...
        if module_config.guided_zero_shot:
            return await generate_guided_zero_shot_suggestions(exercise, submission, module_config.guided_zero_shot, module_config.debug)
