...
ModelConfigType = openai_config.OpenAIModelConfig if 'ReplicateModelConfig' not in globals() else Union[openai_config.OpenAIModelConfig, replicate_config.ReplicateModelConfig]